...
for q in range(0,len(measurements)):
    ...
    Temp=290                # approximate Temperature of water surface 
    ...
    #Get downwelling athomsferic transmittance
    ...
    L_down_transmit=np.mean(L_down['transmission'])
    ...
    if q > 3:
        ...
        ta = Weatherstation.loc[pd.to_datetime(Datetime),'v02humidity']/100 
    elif q == 1:
        RH = 0.52
        ta = 25.1
    elif q == 0:
        ...
        #   CALCULATE transmissivity ath pathlengh z
            ...
            for i in range(0,y_res):
               for j in range(0,x_res):
                   ...
                   transmissivity_corr[i][j] = pfs.transmissivity(RH,Temp,dist,TIRlambda_min,TIRlambda_max,PLWater)
